    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        private async void ChangePassword_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == ContentDialogResult.Primary)
            {
                ...
                await ShowMessageAsync("成功", "主密码已修改");
            }
        }
        ...
        private async void SecurityQuestions_Click(object sender, RoutedEventArgs e)
        {
            ...
            var q1 = new TextBox { Header = "问题 1", PlaceholderText = "您的出生城市是？" };
            var a1 = new TextBox { Header = "答案 1", PlaceholderText = "输入答案" };
            var q2 = new TextBox { Header = "问题 2", PlaceholderText = "您母亲的名字是？" };
            var a2 = new TextBox { Header = "答案 2", PlaceholderText = "输入答案" };
            var q3 = new TextBox { Header = "问题 3", PlaceholderText = "您的第一所学校是？" };
            var a3 = new TextBox { Header = "答案 3", PlaceholderText = "输入答案" };
        ...
        private async void ResetPassword_Click(object sender, RoutedEventArgs e)
        {
            ...
            { 
                Text = "请回答您设置的密保问题来重设主密码",
                TextWrapping = TextWrapping.Wrap,
                Opacity = 0.7
            };
            var a1 = new TextBox { Header = "问题 1 的答案", PlaceholderText = "输入答案" };
            var a2 = new TextBox { Header = "问题 2 的答案", PlaceholderText = "输入答案" };
            var a3 = new TextBox { Header = "问题 3 的答案", PlaceholderText = "输入答案" };
            var newPassword = new PasswordBox { Header = "新密码", PlaceholderText = "输入新密码" };
            ...
            if (result == ContentDialogResult.Primary)
            {
                ...
                await ShowMessageAsync("提示", "此功能正在开发中");
            }
        }
